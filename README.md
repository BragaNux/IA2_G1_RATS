...
2. **DOHMH Rodent Inspection** — [NYC Open Data](https://data.cityofnewyork.us/Health/Rodent-Inspection/p937-wjvj). Inspeções sanitárias/controle de pragas realizadas pelo Department of Health and Mental Hygiene, usadas para medir densidade de atividade de inspeção próxima a cada chamado.
